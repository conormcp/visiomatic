...
L.SpinBox = L.Evented.extend({
  ...
  initialize: function (parent, options) {
    ...
    var _this = this,
      ...
      input = (this._input = L.DomUtil.create(
        "input",
        options.className + "-input",
        wrap
      )),
      down = (this._down = L.DomUtil.create(
        "div",
        options.className + "-down",
        wrap
      )),
      up = (this._up = L.DomUtil.create(
        "div",
    ...
    L.DomEvent.disableClickPropagation(wrap).disableScrollPropagation(wrap);
