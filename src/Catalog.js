    ...
    for (var i in this.properties) {
      if (this.propertyMask === undefined || this.propertyMask[i] === true) {
        str +=
          ...
          ":</TD>" +
          "<TD>" +
          feature.properties.items[i].toString() +
          " ";
        if (this.units[i]) {
          str += this.units[i];
        }
...
L.Catalog["2MASS"] = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=II/246&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=II/246&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.SDSS = L.extend({}, L.Catalog, {
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=V/147/sdss12&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.PanSTARRS1 = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=II/349&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=II/349/ps1&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.PPMXL = L.extend({}, L.Catalog, {
  ...
  className: "logo-catalog-vizier",
  attribution:
    "PPM-Extended, positions and proper motions (Roeser et al. 2008)",
  color: "green",
  maglim: 20.0,
  regionType: "box",
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=I/317&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=I/317&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.Abell = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=VII/110A&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=VII/110A&-c={ra},{dec},eq=J2000&-c.rs=0.2",
});
...
L.Catalog.NVSS = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=VIII/65/NVSS&" +
...
L.Catalog.FIRST = L.extend({}, L.Catalog, {
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=VIII/92/first14&-c={ra},{dec},eq=J2000&-c.rs=0.2",
  draw: function (feature, latlng) {
    return L.ellipse(latlng, {
      majAxis: feature.properties.items[1] / 7200.0,
      minAxis: feature.properties.items[2] / 7200.0,
...
L.Catalog.AllWISE = L.extend({}, L.Catalog, {
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=II/328/allwise&-c={ra},{dec},eq=J2000&-c.rs=0.2",
});
...
L.Catalog.GALEX_AIS = L.extend({}, L.Catalog, {
  ...
  className: "logo-catalog-vizier",
  attribution:
    "GALEX catalogs of UV sources: All-sky Imaging Survey (Bianchi et al. 2011)",
  color: "magenta",
  maglim: 21.0,
  regionType: "box",
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=II/312/ais&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=II/312/ais&-c={ra},{dec},eq=J2000&-c.rs=0.2",
});
...
L.Catalog.GAIA_DR1 = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=I/337/gaia&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=I/337/gaia&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.GAIA_DR2 = L.extend({}, L.Catalog, {
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=I/345/gaia2&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=I/345/gaia2&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.URAT_1 = L.extend({}, L.Catalog, {
  ...
  className: "logo-catalog-vizier",
  attribution:
    "The first U.S. Naval Observatory Astrometric Robotic Telescope Catalog (Zacharias et al. 2015)",
  color: "yellow",
  maglim: 17.0,
  regionType: "box",
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=I/329&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=I/329&-c={ra},{dec},eq=J2000&-c.rs=0.01",
});
...
L.Catalog.GLEAM = L.extend({}, L.Catalog, {
  ...
  className: "logo-catalog-vizier",
  attribution:
    "GaLactic and Extragalactic All-sky Murchison Wide Field Array (GLEAM)" +
  ...
  url:
    L.Catalog.vizierURL +
    "/asu-tsv?&-mime=csv&-source=VIII/100/gleamegc&" +
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-5?-source=-source=VIII/100/gleamegc&-c={ra},{dec},eq=J2000&-c.rs=0.2",
  draw: function (feature, latlng) {
    return L.ellipse(latlng, {
...
L.Catalog.TGSS = L.extend({}, L.Catalog, {
  ...
  objurl:
    L.Catalog.vizierURL +
    "/VizieR-3?-source=-source=J/A%2bA/598/A78/table3&-c={ra},{dec},eq=J2000&-c.rs=0.2",
  draw: function (feature, latlng) {
    return L.ellipse(latlng, {
      majAxis: feature.properties.items[1] / 7200.0,
      minAxis: feature.properties.items[2] / 7200.0,
