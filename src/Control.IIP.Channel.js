...
*/
      ...
      chanList = this._channelList = L.DomUtil.create(
        "div",
    ...
    for (c in chanLabels) {
      ...
      if (rgb.isOn()) {
        chanElem = L.DomUtil.create(
          "div",
          this._className + "-channel",
          chanList
        );
        color = L.DomUtil.create(
          "div",
